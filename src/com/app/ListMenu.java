...
public class ListMenu {
    private PrintStream sysOut = new PrintStream(System.out);
    private User user;
    ...
    public void getFilterSelectionProjectМenu() {
    ...
    public void getFilterSelectionUserМenu() {
        sysOut.println("================================Меню выбора фильтра================================");
        sysOut.println("Выберите фильтр:");
        sysOut.println("1. Поиск по номеру");
    ...
    public void getFilterSelectionTaskМenu() {
        sysOut.println("================================Меню выбора фильтра================================");
        sysOut.println("Выберите фильтр:");
        sysOut.println("1. Поиск по номеру");
    ...
    public String getSelectAllUser () {
        return ("SELECT * FROM testproject.user WHERE ActivUser <> 0;");
    }
    public String getSelectAllProject () {
        return ("SELECT * FROM testproject.project WHERE ActivProject <> 0;");
    }
    ...
    public String getInsertProject () {
        return ("INSERT INTO Project (NameProject) VALUE(?);");
    }
    public String getInsertUser () {
        return ("INSERT INTO User (SurnameUser, NameUser, MiddleNameUser, PostUser) VALUE(?, ?, ?, ?);");
    }
    public String getInsertTask () {
        return ("INSERT INTO Task (TopicTask, ProjectId, TypeId, PriorityId, UserId, DescriptionTask) VALUE(?, ?, ?, ?, ?, ?);");
    }
    ...
    public void getWheleProject(ResultSet resultSet) throws SQLException{
        while (resultSet.next()) {
            project = new Project(resultSet.getLong(1), resultSet.getString(2));
            sysOut.println(project);
        }        
    }
    public void getWheleTask(ResultSet resultSet) throws SQLException{
        while (resultSet.next()) {
            task = new Task(resultSet.getLong(1), 
            resultSet.getString(2), 
            resultSet.getString(3), 
            resultSet.getString(4), 
            resultSet.getString(5), 
    ...
    public void setLog (String masseng){
